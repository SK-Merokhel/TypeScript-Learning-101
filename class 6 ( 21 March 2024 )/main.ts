...
let email:string = "sufyan@gmail.com" // I have made variable string, assigned myself
// This is called strong typing 
// When TypeScript assigns the type itself then it is called inference 
let pwd:string = "12345";
...
let weather: string = "Rainny"; // Declaring and initializing the weather variable
...
let greeting: string = "After noon"; // Declaring and initializing the greeting variable
...
let num1: number = 6; // Declare a variable num1 of type number and assign it the value 6
num1 = 8; // Change the value of num1 to 8
num1 = 4; // Change the value of num1 to 4 (this is the final value of num1)
let num2: number = 6; // Declare a variable num2 of type number and assign it the value 6
